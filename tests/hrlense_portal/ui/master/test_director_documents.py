"""
UI Test Suite for Director Documents Module under Masters (HR Lens Portal).
...
from workflows.hrlense_portal.master.director_documents_workflow import DirectorDocumentsWorkflow
